...
def test_functions_missing_return(agent_framework: AgentFramework) -> None:
...
def test_functions_missing_docstring(agent_framework: AgentFramework) -> None:
...
def test_functions_missing_type(agent_framework: AgentFramework) -> None:
...
def test_functions_valid(agent_framework: AgentFramework) -> None:
