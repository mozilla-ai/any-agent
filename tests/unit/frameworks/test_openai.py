...
def test_load_openai_default() -> None:
    ...
    with (
        ...
        mock_agent.assert_called_once_with(
            name="any_agent",
            model=mock_anyllm_model.return_value,
            instructions=None,
            tools=[],
            mcp_servers=[],
        )
