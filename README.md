...
- **[Creating an agent with MCP](https://mozilla-ai.github.io/any-agent/cookbook/mcp/)** - Integrate Model Context Protocol tools
- **[Serve an Agent with A2A](https://mozilla-ai.github.io/any-agent/cookbook/a2a/)** - Deploy agents with Agent-to-Agent communication
