...
class OpenAIAgent(AnyAgent):
    ...
    async def load_agent(self) -> None:
        ...
        if self.managed_agents:
            for managed_agent in self.managed_agents:
                ...
                instance = Agent(
                    ...
                    tools=managed_tools,
                    mcp_servers=[
                        managed_mcp_server.server  # type: ignore[attr-defined, union-attr]
        ...
        self._agent: Agent = Agent(
            ...
            handoffs=handoffs,
            tools=tools,
            mcp_servers=[mcp_server.server for mcp_server in mcp_servers],  # type: ignore[attr-defined, union-attr]
            **kwargs_,
        )
