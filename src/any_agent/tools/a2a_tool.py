...
async def a2a_tool(url: str, toolname: str | None = None) -> Callable[[str], Coroutine[Any, Any, str]]:
    ...
    if toolname:
        ...
        _send_query.__name__ = f"call_{re.sub(r'\s+', '_', a2a_agent_card.name.strip())}"
